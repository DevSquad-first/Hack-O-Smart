...
allbusdoc.forEach(element => {
    ...
    document.getElementById("pbs-stops-list").appendChild(createDiv)
    document.getElementById("pbs-stops-list").appendChild(createDiv1)
...
async function drawChart() {   
  try {
    ...
    const response = await axios.post('http://localhost:5555/pbs', {
        method: 'POST',
      data: {
        lat: ""+lati,
        lng: ""+lngi
    ...
    var chart = new google.visualization.Map(document.getElementById('pbs-stop-map'));
